            ...
            <input type="checkbox" name="pilih_keranjang[]" value="<?= $produk['id_keranjang'] ?>" class="form-check-input me-2" style="transform: scale(1.3);">
                ...
                <div class="ms-3">
                    ...
                    <form method="post" class="d-flex align-items-center">
                        ...
                        <input type="hidden" name="jumlah" value="<?php echo $produk['jumlah_produk']; ?>">
                        <!-- Tombol kurang -->
        ...
        <div class="col-md-4">
            <div class="summary p-3">
                ...
                <form action="pembayaran.php" method="post">
                    <?php 
                    mysqli_data_seek($queryKeranjang, 0); // reset pointer result
                    while ($produk = mysqli_fetch_array($queryKeranjang)) { ?>
                        <input type="hidden" name="produk[<?= $produk['id_produk'] ?>]" value="<?= $produk['jumlah_produk'] ?>">
                        <input type="hidden" name="ukuran[<?= $produk['id_produk'] ?>]" value="<?= $produk['ukuran'] ?>">
                    <?php } ?>
